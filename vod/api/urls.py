...
from .views import (
    ...
    MoviesSeriesSearchAPIView, CommentCreateAPIView, CommentListAPIView, CommentUpdateAPIView, CommentDeleteAPIView,
    ReviewCreateAPIView, ReviewListAPIView, ReviewUpdateAPIView, ReviewDeleteAPIView,
